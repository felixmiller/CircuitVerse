...
Devise.setup do |config|
  ...
  # config.pepper = 'dcceaa915f7abd9c1314cb6b9c5df1fabc3c1909a7f4a73180f4695a67edffa8850c3f6dae0e7cd5fe57a8ef1fb46aae52cbaa5b11d4039630728befee38165d'
  ...
  config.warden do |manager|
    ...
    manager.default_strategies(scope: :user).unshift :jwt_token
    manager.failure_app = Circuitverse::FailureApp
  end
